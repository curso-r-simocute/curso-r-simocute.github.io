...
* Sitio oficial de RStudio: [RStudio - Open source & professional software for data sciencie teams](https://www.rstudio.com/).
...
# El lenguaje R
En esta sección, se explican algunos de los aspectos principales de la [definición del lenguaje R](https://cran.r-project.org/doc/manuals/r-release/R-lang.html). Específicamente, el concepto de función y los tipos de datos que maneja R.
...
### Ejemplos
La función [print()](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/print) recibe como argumento un valor (ej. un texto o un número) para imprimirlo en la pantalla. En el siguiente fragmento de código en R, se utiliza ```print()``` para imprimir la hilera ["Hola mundo"](https://en.wikipedia.org/wiki/%22Hello,_World!%22_program). Nótese el uso del símbolo ```#``` para comentarios (i.e. texto que no es código ejecutable).
...
En otro ejemplo, la función  [mean()](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/mean) retorna la media aritmética del argumento de entrada. En el siguiente ejemplo, se calcula la media de los números de un vector creado a su vez con la función [c()](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/c).
...
La función ```setwd()``` (_set working directory_) establece la ruta del directorio de trabajo de la sesión actual de R. Como argumento, recibe una hilera de texto con la ruta.
...
### Argumentos
Los argumentos de las funciones tienen nombres que pueden especificarse, en caso de ser necesario. En el siguiente ejemplo, se utilizan los nombres de los argumentos ```x```, ```xlab``` y ```ylab``` de la función [plot()](https://www.rdocumentation.org/packages/graphics/versions/3.6.2/topics/plot) para especificar la fuente de datos y las etiquetas de los ejes x e y de un gráfico.
...
Para obtener ayuda de una función desde la línea de comandos de R, puede utilizarse un signo de pregunta (```?```) seguido del nombre de la función o bien la función [help()](https://www.rdocumentation.org/packages/utils/versions/3.6.2/topics/help). Por ejemplo:
...
Adicionalmente, puede utilizarse la función [apropos()](https://www.rdocumentation.org/packages/utils/versions/3.6.2/topics/help) para buscar funciones por palabras clave.
...
La función [example()](https://www.rdocumentation.org/packages/utils/versions/3.6.2/topics/example) presenta ejemplos sobre el uso de una función.
...
Por otra parte, los sitios [R Documentation and manuals - R Documentation](https://www.rdocumentation.org/) y [All R Documentation](https://rdrr.io/r/) reúnen documentación de las funciones de R. También puede obtenerse ayuda sobre una función en los buscadores de Internet (ej. Google), además de ejemplos, tutoriales y otros materiales de apoyo. 

### Bibliotecas y paquetes
Las funciones de R se agrupan en conjuntos llamados bibliotecas, las cuales se distribuyen en paquetes. Para utilizar un paquete, primero debe cargarse (en la memoria del computador) con la función [library()](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/library).
...
La función [seq()](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/seq) también crea un vector con base en una secuencia y permite especificar argumentos como un valor de incremento y la longitud de la secuencia.
