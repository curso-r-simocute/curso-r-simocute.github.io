...
**Note las barras utilizadas para separar los subdirectorios: /**
...
casos_covid19_ca
```
**Ejercicio**: descargue el archivo del ejemplo anterior (https://raw.githubusercontent.com/curso-r-simocute/datos/main/covid/covid-card.csv) en su computadora y cárguelo en otro data frame mediante ```read.csv()```.
